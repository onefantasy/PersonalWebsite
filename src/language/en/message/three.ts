export default {
  ...
  mazeTip: `Maze play:
    ...
    3. Press the ESC key to exit the mouse lock, and you can view the full map of the maze by sliding the mouse and the wheel.
  `,
  mazeBacktracker: 'Backtracker',
  mazeDivision: 'Division',
